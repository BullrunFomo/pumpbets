...
export default function HomeClient({ markets, totalVolume: totalVolumeProp = null }: { markets: Market[]; totalVolume?: number | null }) {
  ...
  return (
    <div style={{
      ...
      {/* Footer */}
      <div style={{ flexShrink: 0, marginTop: isMobile ? 0 : 'auto', borderTop: '1px solid #1a1a1a', padding: isMobile ? '16px 20px' : '5px 20px', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: isMobile ? 6 : 10 }}>
        {([
